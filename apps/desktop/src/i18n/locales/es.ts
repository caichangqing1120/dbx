...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpPromptHighRiskSql: "Solicitar confirmación para SQL de alto riesgo (solo escritorio; se mantienen las protecciones de solo lectura y producción)",
    mcpSqlApprovalTitle: "Aprobación de SQL de alto riesgo de MCP",
    mcpSqlApprovalScope: "Conexión: {connection} · Base de datos: {database}",
    mcpSqlApprovalOnce: "Solo esta solicitud",
    mcpSqlApprovalHour: "Permitir en esta base de datos durante 1 hora",
    mcpSqlApprovalDay: "Permitir en esta base de datos durante 1 día",
    mcpSqlApprovalDeny: "Denegar",
