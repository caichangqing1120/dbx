...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpPromptHighRiskSql: "高风险 SQL 请求人工确认（仅桌面端；只读和生产库保护不变）",
    mcpSqlApprovalTitle: "MCP 高风险 SQL 授权",
    mcpSqlApprovalScope: "连接：{connection} · 数据库：{database}",
    mcpSqlApprovalOnce: "仅本次",
    mcpSqlApprovalHour: "允许此库 1 小时",
    mcpSqlApprovalDay: "允许此库 1 天",
    mcpSqlApprovalDeny: "拒绝",
