...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpPromptHighRiskSql: "高リスク SQL の実行前に確認する（デスクトップ版のみ。読み取り専用・本番環境の保護は維持）",
    mcpSqlApprovalTitle: "MCP 高リスク SQL の承認",
    mcpSqlApprovalScope: "接続: {connection} · データベース: {database}",
    mcpSqlApprovalOnce: "今回のリクエストのみ",
    mcpSqlApprovalHour: "このデータベースで 1 時間許可",
    mcpSqlApprovalDay: "このデータベースで 1 日許可",
    mcpSqlApprovalDeny: "拒否",
