...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpPromptHighRiskSql: "高風險 SQL 請求人工確認（僅桌面版；唯讀與正式環境保護維持不變）",
    mcpSqlApprovalTitle: "MCP 高風險 SQL 核准",
    mcpSqlApprovalScope: "連線：{connection} · 資料庫：{database}",
    mcpSqlApprovalOnce: "僅本次請求",
    mcpSqlApprovalHour: "允許此資料庫 1 小時",
    mcpSqlApprovalDay: "允許此資料庫 1 天",
    mcpSqlApprovalDeny: "拒絕",
