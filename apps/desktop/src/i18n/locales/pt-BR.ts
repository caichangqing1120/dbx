...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpPromptHighRiskSql: "Pedir confirmação para SQL de alto risco (apenas desktop; proteções de somente leitura e produção permanecem)",
    mcpSqlApprovalTitle: "Aprovação de SQL de alto risco do MCP",
    mcpSqlApprovalScope: "Conexão: {connection} · Banco de dados: {database}",
    mcpSqlApprovalOnce: "Somente esta solicitação",
    mcpSqlApprovalHour: "Permitir neste banco de dados por 1 hora",
    mcpSqlApprovalDay: "Permitir neste banco de dados por 1 dia",
    mcpSqlApprovalDeny: "Negar",
